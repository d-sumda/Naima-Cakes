...
export const HeroSection = () => {
    return (
        <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden px-4 py-24 lg:px-10">
            ...
            <div className="absolute inset-0 z-10 bg-gradient-to-b from-black/40 via-black/30 to-background-light/90 dark:to-background-dark/90" />
            ...
            <div className="relative z-20 mx-auto max-w-4xl text-center w-full">
                ...
                >
                    ...
                    <h1 className="text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-serif font-bold leading-[1.1] tracking-tight text-white drop-shadow-lg">
                        ...
                        <span className="italic text-primary-light">Every Occasion</span>
                    </h1>

                    <p className="max-w-2xl text-lg md:text-xl text-white/90 leading-relaxed drop-shadow-md font-medium">
                    ...
                    <div className="flex flex-wrap justify-center items-center gap-6 md:gap-10 pt-8 text-sm font-semibold text-white/90 drop-shadow-sm">
